 ...
 * @lucene.experimental
 */
public class KNearestNeighbourDocumentClassifier extends KNearestNeighborClassifier implements DocumentClassifier<BytesRef> {
     ...
     */
    public KNearestNeighbourDocumentClassifier(IndexReader leafReader, Similarity similarity, Query query, int k, int minDocsFreq,
