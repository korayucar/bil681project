...
public class SimpleNaiveBayesClassifier implements Classifier<BytesRef> {
     ...
     * index
     */
    protected final IndexReader leafReader;
     ...
     */
    public SimpleNaiveBayesClassifier(IndexReader leafReader, Analyzer analyzer, Query query, String classFieldName, String... textFieldNames) {
